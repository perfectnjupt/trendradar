...
- **Secret (Value)**: Your Feishu custom bot Webhook address (format: `https://open.feishu.cn/open-apis/bot/v2/hook/REDACTED`)
...
1. **View Generated URL**:
   ...
   - Format: `https://hooks.slack.example.invalid/services/REDACTED`
